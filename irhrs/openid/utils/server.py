...
from irhrs.openid.utils.grand_types.implicit import OICDImplicitGrant
...
class OIDCServer(AuthorizationEndpoint, IntrospectEndpoint, TokenEndpoint,
    ...
    def __init__(self, request_validator, token_expires_in=None,
        ...
        openid_connect_implicit = OICDImplicitGrant(request_validator)
        ...
        ResourceEndpoint.__init__(self, default_token='JWT',
